...
let visuals = [
    ...
    },
    {
      initial: { x: -30, y: -10 },
      dragConstraints: 1,
      containerClassname: 'absolute hidden sm:w-12 sm:h-12 sm:right-6 sm:-top-5 sm:block md:right-24 md:-top-8 md:block xl:w-12 xl:h-12 xl:right-12 xl:top-0 xl:block',
